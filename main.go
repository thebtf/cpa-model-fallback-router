...
func pluginRegistration() registration {
	formats := []string{"openai", "openai-response", "claude", "gemini", "codex", "antigravity"}
	return registration{
...
func callHost(method string, payload any) (json.RawMessage, error) {
	...
	if !env.OK {
		if env.Error != nil {
			return nil, statusError{status: env.Error.HTTPStatus, message: strings.TrimSpace(env.Error.Message)}
		}
